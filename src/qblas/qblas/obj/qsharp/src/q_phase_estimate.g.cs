...
[assembly: OperationDeclaration("qblas", "q_phase_estimate_core (U : Microsoft.Quantum.Canon.DiscreteOracle, qs_u : Qubit[], qs_phase : Qubit[]) : ()", new string[] { "Controlled", "Adjoint" }, "X:\\git\\qblas\\src\\qblas\\qblas\\q_phase_estimate.qs", 306L, 11L, 5L)]
#line hidden
namespace qblas
{
...
#line 14 "X:\\git\\qblas\\src\\qblas\\qblas\\q_phase_estimate.qs"
                    var nbit = qs_phase.Count;
#line 16 "X:\\git\\qblas\\src\\qblas\\qblas\\q_phase_estimate.qs"
                    MicrosoftQuantumCanonApplyToEachCA.Apply((((IUnitary)MicrosoftQuantumPrimitiveH), qs_phase));
#line 18 "X:\\git\\qblas\\src\\qblas\\qblas\\q_phase_estimate.qs"
                    foreach (var i in new Range(0L, 1L, (nbit - 1L)))
                    {
#line 20 "X:\\git\\qblas\\src\\qblas\\qblas\\q_phase_estimate.qs"
                        var n = 2L.Pow(i);
#line 21 "X:\\git\\qblas\\src\\qblas\\qblas\\q_phase_estimate.qs"
                        U.Controlled.Apply((new QArray<Qubit>()
                        {qs_phase[i]}, (n, qs_u)));
                    }

#line 24 "X:\\git\\qblas\\src\\qblas\\qblas\\q_phase_estimate.qs"
                    MicrosoftQuantumCanonSwapReverseRegister.Apply(qs_phase);
#line 26 "X:\\git\\qblas\\src\\qblas\\qblas\\q_phase_estimate.qs"
